...
def process_ceas_body_only(csv_path, output_dir, test_size=0.1, dev_size=0.1, seed=42):
    ...
    # Limit to 10,000 samples total
    df = df.sample(n=min(2000, len(df)), random_state=seed).reset_index(drop=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_csv", type=str, default="data/phismall/CEAS_08.csv")
    parser.add_argument("--output_dir", type=str, default="data/phismall")
